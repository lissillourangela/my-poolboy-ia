...
const PoolBoy = (() => {
  ...
  const DEFAULT_SETTINGS = { nom: "Ma piscine", volume: 27, diametre: 5.49, hauteur: 1.32 };
  ...
  /* =======================================================
     6. BASE DE CONNAISSANCE — assistant (problèmes courants)
     ======================================================= */
  const TOPICS = [
  ...
  return { Store, Calc, Diagnostic, hooks, TOPICS, GUIDES };
})();
