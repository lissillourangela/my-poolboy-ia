...
const PoolBoy = (() => {
  ...
  const AIAssistant = {
    async demander() {
      ...
      try {
        ...
        status.textContent = "Diagnostic IA indisponible pour le moment (connexion, ou clé API pas encore configurée). Le diagnostic local ci-dessus reste fiable.";
        result.innerHTML = "";
      } finally {
        btn.disabled = false;
      }
  ...
  return { Store, Calc, Diagnostic, Charts, Weather, Reminders, Notifications, AIAssistant, hooks, TOPICS, GUIDES };
})();
